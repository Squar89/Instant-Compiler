...
OBJS=Absyn.o Lexer.o Parser.o Printer.o CompilerJVM.o CompilerLLVM.o
...
distclean: clean
	rm -f Absyn.C Absyn.H Parser.C Parser.H Lexer.C CompilerJVM.C CompilerJVM.H CompilerLLVM.C CompilerLLVM.H Compiler.H Printer.C Printer.H Makefile InstantLanguage.l InstantLanguage.y InstantLanguage.tex 
...
Jwc.o: Jwc.C Parser.H Printer.H Absyn.H
	${CC} ${CCFLAGS} -c Jwc.C
